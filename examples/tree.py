...
theme = "light"
fill_color = "#000" if theme == "light" else "#fff"
stroke_color = "#fff" if theme == "light" else "#000"
color1 = "#555" if theme == "light" else "#aaa"
color2 = "#999" if theme == "light" else "#666"
...
with open(f"{theme}-tree.svg", "w") as file:
    file.write(str(svg))
