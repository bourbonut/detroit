...
class brush:
    def __init__(self, content="brush"):
    ...
    def move(self, group=None, selection=None, event=None):
        ...
        return brush(content=f"{self.content}.move({arguments})")
    ...
    def clear(self, group=None, event=None):
        ...
        return brush(content=f"{self.content}.clear({arguments})")
    ...
    def extent(self, extent=None):
        ...
        return brush(content=f"{self.content}.extent({arguments})")
    ...
    def filter(self, filter=None):
        ...
        return brush(content=f"{self.content}.filter({arguments})")
    ...
    def touchable(self, touchable=None):
        ...
        return brush(content=f"{self.content}.touchable({arguments})")
    ...
    def keyModifiers(self, modifiers=None):
        ...
        return brush(content=f"{self.content}.keyModifiers({arguments})")
    ...
    def handleSize(self, size=None):
        ...
        return brush(content=f"{self.content}.handleSize({arguments})")
    ...
    def on(self, typenames=None, listener=None):
        ...
        return brush(content=f"{self.content}.on({arguments})")
