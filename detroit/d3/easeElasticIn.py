...
class easeElasticIn:
    def __init__(self, content="easeElasticIn"):
    ...
    def amplitude(self, a=None):
        ...
        return easeElasticIn(content=f"{self.content}.amplitude({arguments})")
    ...
    def period(self, p=None):
        ...
        return easeElasticIn(content=f"{self.content}.period({arguments})")
