...
class easeElasticOut:
    def __init__(self, content="easeElasticOut"):
    ...
    def amplitude(self, a=None):
        ...
        return easeElasticOut(content=f"{self.content}.amplitude({arguments})")
    ...
    def period(self, p=None):
        ...
        return easeElasticOut(content=f"{self.content}.period({arguments})")
