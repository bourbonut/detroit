...
class Graticule:
    ...
    def __init__(self):
        ...
        self.set_step_major([[-180, -90 + EPSILON], [180, 90 - EPSILON]])
        self.set_step_minor([[-180, -80 + EPSILON], [180, 80 - EPSILON]])
    ...
    def step(self, step: Point2D) -> TGraticule:
