...
def curve_cardinal(
    ...
    ... ]
    >>> line(points)
    'M2,2C2,2,4.667,6.667,6,8C7.333,9.333,9,9.667,10,10C11,10.333,11.333,11,12,10C12.667,9,12.667,5,14,4C15.333,3,18.333,3.333,20,4C21.667,4.667,22.500,7.667,24,8C25.500,8.333,27.667,6.667,29,6C30.333,5.333,31,4.167,32,4C33,3.833,34,5.333,35,5C36,4.667,38,2,38,2'
    >>> line = d3.line().curve(d3.curve_cardinal(0.5))
    >>> line(points)
    'M2,2C2,2,5.333,7.333,6,8C6.667,8.667,9.500,9.833,10,10C10.500,10.167,11.667,10.500,12,10C12.333,9.500,13.333,4.500,14,4C14.667,3.500,19.167,3.667,20,4C20.833,4.333,23.250,7.833,24,8C24.750,8.167,28.333,6.333,29,6C29.667,5.667,31.500,4.083,32,4C32.500,3.917,34.500,5.167,35,5C35.500,4.833,38,2,38,2'

    **Result**

    .. image:: ../../figures/light_curve_cardinal.svg
       :align: center
       :class: only-light

    .. image:: ../../figures/dark_curve_cardinal.svg
       :align: center
       :class: only-dark
    """
