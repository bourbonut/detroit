...
def test_intersection_5():
  assert d3.intersection([datetime.strptime("2021-01-01", "%Y-%m-%d"), datetime.strptime("2021-01-03", "%Y-%m-%d")], [datetime.strptime("2021-01-01", "%Y-%m-%d"), datetime.strptime("2021-01-02", "%Y-%m-%d")]) == set([datetime.strptime("2021-01-01", "%Y-%m-%d")])
