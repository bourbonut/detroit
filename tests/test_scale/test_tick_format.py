...
def test_tick_format_3():
    ...
    assert d3.tick_format(0, 9, 10, "e")(2.10) == "2e+00"
    assert d3.tick_format(0, 9, 100, "e")(2.01) == "2.0e+00"
    assert d3.tick_format(0, 9, 100, "e")(2.11) == "2.1e+00"
    assert d3.tick_format(0, 9, 10, "g")(2.10) == "2"
    assert d3.tick_format(0, 9, 100, "g")(2.01) == "2"
