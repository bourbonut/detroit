...
def test_sequential_quantile_1():
...
def test_sequential_quantile_2():
    s = d3.scale_sequential_quantile().set_domain([0, 2, 9, 0.1, 10])
    assert s.get_domain() == [0, 0.1, 2, 9, 10]


def test_sequential_quantile_3():
    s = d3.scale_sequential_quantile().set_domain([0, 2, 9, 0.1, 10])
    assert s.get_range() == [0 / 4, 1 / 4, 2 / 4, 3 / 4, 4 / 4]


def test_sequential_quantile_4():
