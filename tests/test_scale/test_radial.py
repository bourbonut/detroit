...
def test_radial_5():
    assert d3.scale_radial().set_domain([-10, 0]).set_range([2, 3, 4]).set_clamp(True)(-5) == 2.5495097567963922
    assert d3.scale_radial().set_domain([-10, 0]).set_range([2, 3, 4]).set_clamp(True)(50) == 3

def test_radial_6():
    assert d3.scale_radial().set_domain([-10, 0, 100]).set_range([2, 3]).set_clamp(True)(-5) == 2.5495097567963922
    assert d3.scale_radial().set_domain([-10, 0, 100]).set_range([2, 3]).set_clamp(True)(50) == 3

def test_radial_7():
    assert d3.scale_radial().set_domain([0, 0]).set_range([1, 2])(0) == 1.5811388300841898
    assert d3.scale_radial().set_domain([0, 0]).set_range([2, 1])(1) == 1.5811388300841898
