...
def test_hierarchy_1():
    root = d3.hierarchy({"id": "root", "children": [{"id": "a"}, {"id": "b", "children": [{"id": "ba"}]}]})
    a = root.children[0]
    b = root.children[1]
...
def test_hierarchy_2():
    root = d3.hierarchy({"id": "root", "children": [{"id": "a", "children": None}, {"id": "b", "children": 42}]})
    a = root.children[0]
    b = root.children[1]
    assert root.links() == [
        {"source": root, "target": a},
...
def test_hierarchy_7():
    root = d3.hierarchy({"id": "root", "children": [{"id": "a"}, {"id": "b", "children": [{"id": "ba"}]}]}).count()
