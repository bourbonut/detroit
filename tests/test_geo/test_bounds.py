...
def test_bounds_5():
    assert d3.geo_bounds(
        ...
        {"type": "LineString", "coordinates": [[-30, -20], [130, 40]][::-1]}
    )


def test_bounds_6():
    assert d3.geo_bounds(
        {"type": "LineString", "coordinates": [[-123, 39], [-122, 38], [-122, 38]]}
    ) == [[-123, 38], [-122, 39]]
...
def test_bounds_9():
    assert in_delta(
        d3.geo_bounds({"type": "LineString", "coordinates": [[-45, 60], [45, 60]]}),
        [[-45, 60], [45, 67.792345]],
        1e-6,
    )
...
def test_bounds_11():
    assert d3.geo_bounds(
        {"type": "MultiLineString", "coordinates": [[[-123, 39], [-122, 38]]]}
    ) == [[-123, 38], [-122, 39]]
...
def test_bounds_14():
    assert d3.geo_bounds(
        {"type": "MultiPoint", "coordinates": [[-179, 39], [179, 38], [-1, 0], [1, 0]]}
    ) == [[-1, 0], [-179, 39]]
...
def test_bounds_16():
    assert d3.geo_bounds(
        {"type": "MultiPoint", "coordinates": [[-1, 0], [-179, 39], [1, 0], [179, 38]]}
    ) == [[-1, 0], [-179, 39]]
...
def test_bounds_20():
    assert d3.geo_bounds({"type": "Point", "coordinates": [-123, 39]}) == [
        [-123, 39],
        [-123, 39],
    ]
...
def test_bounds_27():
    assert in_delta(
        ...
        [[-180, -89.499961], [180, -80]],
        1e-6,
    )


def test_bounds_28():
    assert d3.geo_bounds({"type": "Sphere"}) == [[-180, -90], [180, 90]]
