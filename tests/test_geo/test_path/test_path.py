...
def path(projection, obj):
    context = ContextTest()
    (d3.geo_path().set_projection(projection).set_context(context)(obj))
...
def test_path_5(equirectangular):
    assert path(equirectangular, {"type": "Point", "coordinates": [-63, 18]}) == [
...
def test_path_6(equirectangular):
    assert path(
        ...
        {"type": "move_to", "x": 170, "y": 160},
        {"type": "arc", "x": 165, "y": 160, "r": 4.5},
        {"type": "move_to", "x": 175, "y": 160},
        {"type": "arc", "x": 170, "y": 160, "r": 4.5},
        {"type": "move_to", "x": 175, "y": 165},
...
def test_path_12(equirectangular):
    assert path(equirectangular, {"type": "Point", "coordinates": [180 + 1e-6, 0]}) == [
...
def test_path_23():
    ...
    assert (
        d3.geo_path().set_digits(40)(line)
        == "M3.141592653589793,2.718281828459045L2.718281828459045,3.141592653589793"
    )
    assert (
        d3.geo_path().set_digits(None)(line)
        == "M3.141592653589793,2.718281828459045L2.718281828459045,3.141592653589793"
    )
...
def test_path_24():
    ...
    assert (
        p2.set_point_radius(1)(point) == "M3.14,2.72m0,1a1,1 0 1,1 0,-2a1,1 0 1,1 0,2z"
    )
    assert p2(point) == "M3.14,2.72m0,1a1,1 0 1,1 0,-2a1,1 0 1,1 0,2z"
    assert p1(point) == "M3.1,2.7m0,2a2,2 0 1,1 0,-4a2,2 0 1,1 0,4z"
    assert (
        p2.set_point_radius(2)(point) == "M3.14,2.72m0,2a2,2 0 1,1 0,-4a2,2 0 1,1 0,4z"
    )
