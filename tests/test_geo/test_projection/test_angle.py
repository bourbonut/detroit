...
def test_angle_1():
    ...
    assert projection_equal(projection, [0, -10], [0, 0.17632698070846498])
    assert projection_equal(projection, [10, 10], [0.17632698070846495, -0.17904710860483972])
    assert projection_equal(projection, [10, -10], [0.17632698070846495, 0.17904710860483972])
    assert projection_equal(projection, [-10, 10], [-0.17632698070846495, -0.17904710860483972])
    assert projection_equal(projection, [-10, -10], [-0.17632698070846495, 0.17904710860483972])
...
def test_angle_2():
    ...
    assert projection_equal(projection, [0, 0], [0, 0])
    assert projection_equal(projection, [10, 0], [0.1527036446661393, -0.08816349035423247])
    assert projection_equal(projection, [-10, 0], [-0.1527036446661393, 0.08816349035423247])
    assert projection_equal(projection, [0, 10], [-0.08816349035423247, -0.1527036446661393])
    assert projection_equal(projection, [0, -10], [0.08816349035423247, 0.1527036446661393])
    assert projection_equal(projection, [10, 10], [0.06318009036371944, -0.24322283488017502])
    assert projection_equal(projection, [10, -10], [0.24222719896855913, 0.0668958541717101])
    assert projection_equal(projection, [-10, 10], [-0.24222719896855913, -0.0668958541717101])
    assert projection_equal(projection, [-10, -10], [-0.06318009036371944, 0.24322283488017502])
