...
def test_format_type_s_1():
    ...
    assert f(0.00001) == "10.0000µ"
    assert f(0.000001) == "1.00000µ"
...
def test_format_type_s_2():
    ...
    assert f1(1e26) == "100Y"
    assert f1(0.000001) == "1.00µ"
    assert f1(0.009995) == "10.0m"
    f2 = d3.format(".4s")
    assert f2(999.5) == "999.5"
    assert f2(999500) == "999.5k"
    assert f2(0.009995) == "9.995m"
...
def test_format_type_s_4():
    f = d3.format(".8s")
    assert f(1.23e21) == "1.2300000Z"
    assert f(1.23e22) == "12.300000Z"
    assert f(1.23e23) == "123.00000Z"
    assert f(1.23e24) == "1.2300000Y"
    assert f(1.23e25) == "12.300000Y"
    assert f(1.23e26) == "123.00000Y"
    assert f(1.23e27) == "1230.0000Y"
    assert f(1.23e28) == "12300.000Y"
    assert f(1.23e29) == "123000.00Y"
    assert f(1.23e30) == "1230000.0Y"
    assert f(-1.23e21) == "-1.2300000Z"
    assert f(-1.23e22) == "-12.300000Z"
    assert f(-1.23e23) == "-123.00000Z"
    assert f(-1.23e24) == "-1.2300000Y"
...
def test_format_type_s_5():
    ...
    assert f2(1e26) == "$100Y"
    assert f2(0.000001) == "$1.00µ"
    assert f2(0.009995) == "$10.0m"
    f3 = d3.format("$.4s")
    assert f3(999.5) == "$999.5"
    assert f3(999500) == "$999.5k"
    assert f3(0.009995) == "$9.995m"
...
def test_format_type_s_6():
    ...
    assert f2(1e1) == "10.00"
    assert f2(1e2) == "100.0"
    assert f2(1e3) == "1.000k"
    assert f2(1e4) == "10.00k"
    assert f2(1e5) == "100.0k"
