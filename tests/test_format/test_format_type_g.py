...
def test_format_type_g_1():
    ...
    assert d3.format(".1g")(100) == "1e+2"
    assert d3.format(".2g")(100) == "1.0e+2"
    assert d3.format(".3g")(100) == "100"
    assert d3.format(".5g")(100) == "100.00"
    assert d3.format(".5g")(100.2) == "100.20"
    assert d3.format(".2g")(0.002) == "0.0020"
