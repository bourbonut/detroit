...
def test_format_type_e_1():
    ...
    assert f(-4) == "−4.000000e+0"
    assert f(-42) == "−4.200000e+1"
    assert f(-4200000) == "−4.200000e+6"
    assert f(-42000000) == "−4.200000e+7"
    assert d3.format(".0e")(42) == "4e+1"
    assert d3.format(".3e")(42) == "4.200e+1"

def test_format_type_e_2():
    assert d3.format("1e")(-0) == "0.000000e+0"
    assert d3.format("1e")(-1e-12) == "−1.000000e-12"

def test_format_type_e_3():
    assert d3.format(",e")(math.inf) == "math.inf"

def test_format_type_e_4():
    assert d3.format(".3e")(-math.inf) == "−math.inf"
