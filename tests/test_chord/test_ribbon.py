...
def test_ribbon_7():
    ...
    value = ChordItem(ChordValue(0, 0.7524114, 1.1212972, 1), ChordValue(0, 1.8617078, 1.9842927, 1))
    assert r(value) == "M164.016,-175.210A240,240,0,0,1,216.160,-104.283Q0,0,229.916,68.838A240,240,0,0,1,219.773,96.435Q0,0,164.016,-175.210Z"
