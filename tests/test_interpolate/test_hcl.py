...
def test_hcl_2():
    ...
    assert d3.interpolate_hcl("rgba(70, 130, 180, 1)", "rgba(255, 0, 0, 0.2)")(0.2) == "rgba(106, 121, 206, 0.84)"
...
def test_hcl_7():
    assert d3.interpolate_hcl("#f60", d3.hcl(math.nan, math.nan, 0))(0.5) == "rgb(155, 0, 0)"
    assert d3.interpolate_hcl("#6f0", d3.hcl(math.nan, math.nan, 0))(0.5) == "rgb(0, 129, 0)"

def test_hcl_8():
    assert d3.interpolate_hcl(d3.hcl(math.nan, math.nan, 0), "#f60")(0.5) == "rgb(155, 0, 0)"
    assert d3.interpolate_hcl(d3.hcl(math.nan, math.nan, 0), "#6f0")(0.5) == "rgb(0, 129, 0)"

def test_hcl_9():
    assert d3.interpolate_hcl("#ccc", d3.hcl(math.nan, math.nan, 0))(0.5) == "rgb(97, 97, 97)"
    assert d3.interpolate_hcl("#f00", d3.hcl(math.nan, math.nan, 0))(0.5) == "rgb(166, 0, 0)"

def test_hcl_10():
    assert d3.interpolate_hcl(d3.hcl(math.nan, math.nan, 0), "#ccc")(0.5) == "rgb(97, 97, 97)"
    assert d3.interpolate_hcl(d3.hcl(math.nan, math.nan, 0), "#f00")(0.5) == "rgb(166, 0, 0)"
