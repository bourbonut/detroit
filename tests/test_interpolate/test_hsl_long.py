...
def test_hsl_long_1():
    ...
    assert d3.interpolate_hsl_long("steelblue", d3.hsl("brown"))(1) == str(
        d3.rgb("brown")
    )
    assert d3.interpolate_hsl_long("steelblue", d3.rgb("brown"))(1) == str(
        d3.rgb("brown")
    )
...
def test_hsl_long_2():
    ...
    assert (
        d3.interpolate_hsl_long("rgba(70, 130, 180, 1)", "rgba(255, 0, 0, 0.2)")(0.2)
