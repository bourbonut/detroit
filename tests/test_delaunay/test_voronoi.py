...
def test_voronoi_1():
    voronoi = d3.Delaunay.from_points([[0, 0], [1, 0], [0, 1], [1, 0]]).voronoi([-1, -1, 2, 2])
...
def test_voronoi_4():
    delaunay = d3.Delaunay.from_points([[0, 0], [300, 0], [0, 300], [300, 300], [100, 100]])
...
def test_voronoi_5():
    ...
    voronoi = delaunay.voronoi([-500, -500, 500, 500])
    assert voronoi.cell_polygon(0) == [[500, -500], [500, 500], [-500, 500], [-500, -500], [500, -500]]
...
def test_voronoi_6():
    voronoi1 = d3.Delaunay.from_points([[50, 10], [10, 50], [10, 10], [200, 100]]).voronoi([40, 40, 440, 180])
...
def test_voronoi_7():
     voronoi = d3.Delaunay.from_points([[300, 10], [200, 100], [300, 100], [10, 10], [350, 200], [350, 400]]).voronoi([0, 0, 500, 150])
     assert [sorted(voronoi.neighbors(i)) for i in range(6)] == [ [1, 2], [0, 2, 3], [0, 1, 4], [1], [2], []]
...
def test_voronoi_9():
    pts = [[424.75, 253.75],[424.75, 253.74999999999997],[407.17640687119285, 296.17640687119285],[364.75, 313.75],[322.32359312880715, 296.17640687119285],[304.75, 253.75],[322.32359312880715, 211.32359312880715],[364.75, 193.75],[407.17640687119285, 211.32359312880715],[624.75, 253.75],[607.1764068711929, 296.17640687119285],[564.75, 313.75],[522.3235931288071, 296.17640687119285],[504.75, 253.75],[564.75, 193.75]
    ]
...
def test_voronoi_11():
    ...
    assert [sorted(voronoi.neighbors(i)) for i in range(4)] == [[1], [0, 2, 3], [1, 3], [1, 2]]
...
def test_voronoi_17():
    ...
    assert [[[round(x) for x in d] for d in p] for p in voronoi.cell_polygons()] == [[[0,40],[0,0],[50,0],[50,40],[0,40]],[[100,0],[100,40],[50,40],[50,0],[100,0]],[[150,0],[150,40],[100,40],[100,0],[150,0]],[[150,40],[150,0],[200,0],[200,40],[150,40]],[[250,0],[250,40],[200,40],[200,0],[250,0]]]
