...
from detroit.coloration.color import RGB, HSL
import math
...
def test_color_15():
    ...
    assert hsl_approx_equal(d3.color("hsl(+120,+30%,+50%)"), 120, 0.3, 0.5, 1)
    assert approx_equal(d3.color("rgb(-120,-30,-50)"), -120, -30, -50, 1)
    assert hsl_approx_equal(d3.color("hsl(-120,-30%,-50%)"), math.nan, math.nan, -0.5, 1)
    assert approx_equal(d3.color("rgba(12,34,56,+0.4)"), 12, 34, 56, 0.4)
    assert approx_equal(d3.color("rgba(12,34,56,-0.4)"), math.nan, math.nan, math.nan, -0.4)
    assert approx_equal(d3.color("rgba(12%,34%,56%,+0.4)"), 31, 87, 143, 0.4)
    assert approx_equal(d3.color("rgba(12%,34%,56%,-0.4)"), math.nan, math.nan, math.nan, -0.4)
    assert hsl_approx_equal(d3.color("hsla(60,100%,20%,+0.4)"), 60, 1, 0.2, 0.4)
    assert hsl_approx_equal(d3.color("hsla(60,100%,20%,-0.4)"), math.nan, math.nan, math.nan, -0.4)
...
def test_color_18():
    ...
    assert hsl_approx_equal(d3.color("hsla(9e-1,3e-1%,5e-1%,5e-1)"), 0.9, 0.003, 0.005, 0.5)
