...
from detroit.coloration.lab import HCL, LAB
...
def test_hcl_2():
    assert approx_equal(
        d3.hcl("#abc"), 252.37145234745182, 11.223567114593477, 74.96879980931759, 1
    )
...
def test_hcl_16():
    assert approx_equal(
        d3.hcl("#abcdef"), 254.0079700170605, 21.62257586147983, 80.77135418262527, 1
    )
    assert approx_equal(
        d3.hcl("#abc"), 252.37145234745182, 11.223567114593477, 74.96879980931759, 1
    )
    ...
    assert approx_equal(
        d3.hcl("aliceblue"), 247.7353849904697, 4.681732046417135, 97.12294991108756, 1
    )
...
def test_hcl_21():
    ...
    assert approx_equal(
        c.brighter(0.5), 32.28342524928155, 59.60231039142763, 47.149667346714935, 0.4
    )
    assert approx_equal(
        c.brighter(1), 32.28342524928155, 59.60231039142763, 56.149667346714935, 0.4
    )
    assert approx_equal(
        c.brighter(2), 32.28342524928155, 59.60231039142763, 74.14966734671493, 0.4
    )
...
def test_hcl_22():
    ...
    c2 = c1.brighter(1)
    assert approx_equal(
        c1, 255.71009124439382, 33.88100417355615, 51.98624890550498, 0.4
    )
    assert approx_equal(
        c2, 255.71009124439382, 33.88100417355615, 69.98624890550498, 0.4
    )
...
def test_hcl_25():
    c = d3.hcl("rgba(165, 42, 42, 0.4)")
    assert approx_equal(
        c.darker(0.5), 32.28342524928155, 59.60231039142763, 29.149667346714935, 0.4
    )
    assert approx_equal(
        c.darker(1), 32.28342524928155, 59.60231039142763, 20.149667346714935, 0.4
    )
    assert approx_equal(
        c.darker(2), 32.28342524928155, 59.60231039142763, 2.149667346714935, 0.4
    )
...
def test_hcl_26():
    ...
    assert approx_equal(
        c2, 255.71009124439382, 33.88100417355615, 33.98624890550498, 0.4
    )
