...
def test_hsl_5():
    ...
    assert (
        d3.hsl("rgba(12%, 34%, 56%, 0.4)").format_hsl()
...
def test_hsl_9():
    ...
    assert (
        str(d3.hsl(math.nan, 0.5, 0.4)) == "rgb(102, 102, 102)"
    )  # equivalent to hsl(*, 0, 0.4)
    assert str(d3.hsl(120, math.nan, 0.4)) == "rgb(102, 102, 102)"
    assert str(d3.hsl(math.nan, math.nan, 0.4)) == "rgb(102, 102, 102)"
    assert (
        str(d3.hsl(120, 0.5, math.nan)) == "rgb(0, 0, 0)"
    )  # equivalent to hsl(120, 0.5, 0)
...
def test_hsl_23():
    ...
    assert approx_equal(
        d3.hsl("hsla(120,20%,10%,-0.1)"), math.nan, math.nan, math.nan, -0.1
    )
