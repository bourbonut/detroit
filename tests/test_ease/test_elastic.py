...
def test_elastic_3():
    assert d3.ease_elastic_in(0.9) == d3.ease_elastic_in(0.9)
...
def test_elastic_6():
    assert d3.ease_elastic_in.amplitude(1.3).period(0.2)(
        0.9
    ) == d3.ease_elastic_in.amplitude(1.3).period(0.2)(0.9)
...
def test_elastic_10():
    assert d3.ease_elastic_out.amplitude(1.3).period(0.2)(
        0.9
    ) == d3.ease_elastic_out.amplitude(1.3).period(0.2)(0.9)
...
def test_elastic_12():
    assert d3.ease_elastic_in_out.amplitude(1.3).period(0.2)(
        0.9
    ) == d3.ease_elastic_in_out.amplitude(1.3).period(0.2)(0.9)
