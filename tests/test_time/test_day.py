...
def test_time_day_offset():
    assert d3.time_day.offset(datetime(2011, 12, 31, 23, 59, 59, 999), 0) == datetime(
        2011, 12, 31, 23, 59, 59, 999
    )
    d = datetime(2010, 12, 31, 23, 59, 59, 999)
    assert d3.time_day.offset(d, 1) == datetime(2011, 1, 1, 23, 59, 59, 999)
    assert d3.time_day.offset(datetime(2010, 12, 31, 23, 59, 59, 999), +1) == datetime(
        2011, 1, 1, 23, 59, 59, 999
    )
    assert d3.time_day.offset(datetime(2010, 12, 31, 23, 59, 59, 456), -2) == datetime(
        2010, 12, 29, 23, 59, 59, 456
    )
    ...
    assert d3.time_day.offset(datetime(2010, 12, 31, 23, 59, 59, 999), 0) == datetime(
        2010, 12, 31, 23, 59, 59, 999
    )
    assert d3.time_day.offset(datetime(2010, 12, 31, 23, 59, 58, 0), 0) == datetime(
...
def test_time_day_range():
    ...
    assert d3.time_day.range(
        datetime(2011, 11, 4, 2), datetime(2011, 11, 14, 13), 3
    ) == [
        datetime(2011, 11, 5),
        datetime(2011, 11, 8),
        datetime(2011, 11, 11),
...
def test_time_day_count():
    ...
    assert (
        d3.time_day.count(datetime(2000, 1, 1), datetime(2000, 12, 31)) == 365
    )  # leap year
    ...
    assert (
        d3.time_day.count(datetime(2004, 1, 1), datetime(2004, 12, 31)) == 365
    )  # leap year
    ...
    assert (
        d3.time_day.count(datetime(2008, 1, 1), datetime(2008, 12, 31)) == 365
    )  # leap year
...
def test_time_day_every():
    assert d3.time_day.every(3).range(
        datetime(2008, 12, 30, 0, 12), datetime(2009, 1, 5, 23, 48)
    ) == [datetime(2008, 12, 31), datetime(2009, 1, 1), datetime(2009, 1, 4)]
    assert d3.time_day.every(5).range(
        datetime(2008, 12, 30, 0, 12), datetime(2009, 1, 6, 23, 48)
    ) == [
        datetime(2008, 12, 31, 0, 0),
        datetime(2009, 1, 1, 0, 0),
        datetime(2009, 1, 6, 0, 0),
    ]
    assert d3.time_day.every(7).range(
        datetime(2008, 12, 30, 0, 12), datetime(2009, 1, 8, 23, 48)
    ) == [datetime(2009, 1, 1, 0, 0), datetime(2009, 1, 8, 0, 0)]
