...
def test_time_tuesday_floor():
    assert d3.time_tuesday.floor(datetime(2011, 1, 2, 23, 59, 59)) == datetime(
        2010, 12, 28
    )
    assert d3.time_tuesday.floor(datetime(2011, 1, 3, 0, 0, 0)) == datetime(
        2010, 12, 28
    )
    assert d3.time_tuesday.floor(datetime(2011, 1, 3, 0, 0, 1)) == datetime(
        2010, 12, 28
    )
    assert d3.time_tuesday.floor(datetime(2011, 1, 3, 23, 59, 59)) == datetime(
        2010, 12, 28
    )
