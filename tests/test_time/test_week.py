...
def test_time_week_floor():
  assert d3.time_week.floor(datetime(2010, 12, 31, 23, 59, 59)) == datetime(2010, 12, 26)
  ...
  assert d3.time_week.floor(datetime(2011,  1,  1, 23, 59, 59)) == datetime(2010, 12, 26)
...
def test_time_week_offset():
  assert d3.time_week.offset(datetime(2010, 12, 31, 23, 59, 59, 999), +1), datetime(2011,  1,  7, 23, 59, 59, 999)
  assert d3.time_week.offset(datetime(2010, 12, 31, 23, 59, 59, 456), -2), datetime(2010, 12, 17, 23, 59, 59, 456)
  ...
  assert d3.time_week.offset(datetime(2010, 12, 31, 23, 59, 59, 999), 0), datetime(2010, 12, 31, 23, 59, 59, 999)
  assert d3.time_week.offset(datetime(2010, 12, 31, 23, 59, 58,   0), 0), datetime(2010, 12, 31, 23, 59, 58,   0)
...
def test_time_week_range():
  ...
  assert d3.time_week.range(datetime(2010, 12, 21), datetime(2011, 1, 12))[0], datetime(2010, 12, 26)
  assert d3.time_week.range(datetime(2010, 12, 21), datetime(2011, 1, 12))[2], datetime(2011, 1, 9)
...
def test_time_week_every():
  assert d3.time_week.every(2).range(datetime(2008, 12, 3), datetime(2009, 2, 5)) == [datetime(2008, 12, 7, 0, 0), datetime(2008, 12, 14, 0, 0), datetime(2008, 12, 21, 0, 0), datetime(2008, 12, 28, 0, 0), datetime(2009, 1, 4, 0, 0), datetime(2009, 1, 11, 0, 0), datetime(2009, 1, 18, 0, 0), datetime(2009, 1, 25, 0, 0), datetime(2009, 2, 1, 0, 0)]
