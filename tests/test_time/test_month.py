...
def test_time_month_floor():
  assert d3.time_month.floor(datetime(2010, 12, 31, 23, 59, 59)) == datetime(2010, 12,  1)
...
def test_time_month_ceil():
  assert d3.time_month.ceil(datetime(2010, 12, 31, 23, 59, 59)) == datetime(2011,  1,  1)
...
def test_time_month_offset():
  assert d3.time_month.offset(datetime(2010, 12, 31, 23, 59, 59, 999), +1), datetime(2011,  1, 31, 23, 59, 59, 999)
  assert d3.time_month.offset(datetime(2010, 12, 31, 23, 59, 59, 456), -2), datetime(2010,  10, 31, 23, 59, 59, 456)
  ...
  assert d3.time_month.offset(datetime(2010, 12, 31, 23, 59, 59, 999), 0), datetime(2010, 12, 31, 23, 59, 59, 999)
  assert d3.time_month.offset(datetime(2010, 12, 31, 23, 59, 58,   0), 0), datetime(2010, 12, 31, 23, 59, 58,   0)
  assert d3.time_month.offset(datetime(2010, 12, 31, 23, 59, 59, 999), +1), datetime(2011,  1, 31, 23, 59, 59, 999)
  assert d3.time_month.offset(datetime(2010, 12, 31, 23, 59, 59, 456), -2), datetime(2010,  10, 31, 23, 59, 59, 456)
...
def test_time_month_range():
  ...
  assert d3.time_month.range(datetime(2010, 11, 30), datetime(2011, 3, 1))[0], datetime(2010, 12, 1)
  assert d3.time_month.range(datetime(2010, 11, 30), datetime(2011, 3, 1))[2], datetime(2011, 2, 1)
