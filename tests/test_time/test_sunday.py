...
def test_time_sunday_floor():
  assert d3.time_sunday.floor(datetime(2010, 12, 31, 23, 59, 59)) == datetime(2010, 12, 26)
  ...
  assert d3.time_sunday.floor(datetime(2011,  1,  1, 23, 59, 59)) == datetime(2010, 12, 26)
  ...
  assert d3.time_sunday.ceil(datetime(2010, 12, 31, 23, 59, 59)) == datetime(2011,  1,  2)
...
def test_time_sunday_offset():
  assert d3.time_sunday.offset(datetime(2010, 12, 31, 23, 59, 59, 999), +1), datetime(2011,  1,  7, 23, 59, 59, 999)
  assert d3.time_sunday.offset(datetime(2010, 12, 31, 23, 59, 59, 456), -2), datetime(2010, 12, 17, 23, 59, 59, 456)
  ...
  assert d3.time_sunday.offset(datetime(2010, 12, 31, 23, 59, 59, 999), 0), datetime(2010, 12, 31, 23, 59, 59, 999)
  assert d3.time_sunday.offset(datetime(2010, 12, 31, 23, 59, 58,   0), 0), datetime(2010, 12, 31, 23, 59, 58,   0)
...
def test_time_sunday_range():
  ...
  assert d3.time_sunday.range(datetime(2011, 12,  1, 12, 23), datetime(2012,  1, 14, 12, 23)) == [
    datetime(2011, 12,  4),
    datetime(2011, 12, 11),
    datetime(2011, 12, 18),
    datetime(2011, 12, 25),
