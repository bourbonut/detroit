...
def test_time_ticks_test_1():
  assert d3.time_ticks(datetime(2011, 1, 1, 12, 1, 0), datetime(2011, 1, 1, 12, 4, 4), d3.time_minute) == [
...
def test_time_ticks_test_2():
  assert d3.time_ticks(datetime(2011, 1, 1, 12, 0, 0), datetime(2011, 1, 1, 12, 33, 4), d3.time_minute.every(10)) == [
...
#   assert d3.time_ticks(datetime(2011, 1, 1, 12, 0, 0), datetime(2011, 1, 1, 12, 0, 1), 4) == [
...
def test_time_ticks_test_4():
  assert d3.time_ticks(datetime(2011, 1, 1, 12, 0, 0), datetime(2011, 1, 1, 12, 0, 4), 4) == [
...
def test_time_ticks_test_5():
  assert d3.time_ticks(datetime(2011, 1, 1, 12, 0, 0), datetime(2011, 1, 1, 12, 0, 20), 4) == [
    datetime(2011, 1, 1, 12, 0, 0),
...
def test_time_ticks_test_6():
  assert d3.time_ticks(datetime(2011, 1, 1, 12, 0, 0), datetime(2011, 1, 1, 12, 0, 50), 4) == [
    datetime(2011, 1, 1, 12, 0, 0),
    datetime(2011, 1, 1, 12, 0, 15),
...
def test_time_ticks_test_7():
  assert d3.time_ticks(datetime(2011, 1, 1, 12, 0, 0), datetime(2011, 1, 1, 12, 1, 50), 4) == [
    datetime(2011, 1, 1, 12, 0, 0),
    datetime(2011, 1, 1, 12, 0, 30),
...
def test_time_ticks_datetime():
  assert d3.time_ticks(datetime(2014, 3, 2), datetime(2014, 3, 2), 6), [datetime(2014, 3, 2)]
  assert d3.time_ticks(datetime(2014, 3, 2), datetime(2010, 12, 18), 4), [datetime(2014, 1, 1, 0, 0), datetime(2013, 1, 1, 0, 0), datetime(2012, 1, 1, 0, 0), datetime(2011, 1, 1, 0, 0)]
  assert d3.time_ticks(datetime(2011, 11, 2), datetime(2010, 12, 18), 4), [datetime(2011, 10, 1, 0, 0), datetime(2011, 7, 1, 0, 0), datetime(2011, 4, 1, 0, 0), datetime(2011, 1, 1, 0, 0)]
