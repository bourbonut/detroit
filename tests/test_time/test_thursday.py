...
def test_time_thursday_floor():
  assert d3.time_thursday.floor(datetime(2011,  1,  4, 23, 59, 59)) == datetime(2010, 12, 30)
  assert d3.time_thursday.floor(datetime(2011,  1,  5,  0,  0,  0)) == datetime(2010, 12, 30)
  assert d3.time_thursday.floor(datetime(2011,  1,  5,  0,  0,  1)) == datetime(2010, 12, 30)
  assert d3.time_thursday.floor(datetime(2011,  1,  5, 23, 59, 59)) == datetime(2010, 12, 30)
