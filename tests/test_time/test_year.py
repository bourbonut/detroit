...
def test_time_year_floor():
    assert d3.time_year.floor(datetime(2010, 12, 31, 23, 59, 59)) == datetime(
        2010, 1, 1
    )
...
def test_time_year_offset():
    assert d3.time_year.offset(datetime(2010, 12, 31, 23, 59, 59, 999), +1), datetime(
        2011, 12, 31, 23, 59, 59, 999
    )
    assert d3.time_year.offset(datetime(2010, 12, 31, 23, 59, 59, 456), -2), datetime(
        2008, 12, 31, 23, 59, 59, 456
    )
    ...
    assert d3.time_year.offset(datetime(2010, 12, 31, 23, 59, 59, 999), 0), datetime(
        2010, 12, 31, 23, 59, 59, 999
    )
    assert d3.time_year.offset(datetime(2010, 12, 31, 23, 59, 58, 0), 0), datetime(
...
def test_time_year_range():
    ...
    assert d3.time_year.range(datetime(2010, 1, 1), datetime(2013, 1, 1))[0], datetime(
        2010, 1, 1
    )
    assert d3.time_year.range(datetime(2010, 1, 1), datetime(2013, 1, 1))[2], datetime(
        2012, 1, 1
    )
