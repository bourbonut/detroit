...
def test_monotone_x_1():
    ...
    assert (
        ...
        == "M0,1C0.333,2,0.667,3,1,3C1.333,3,1.667,1,2,1C2.333,1,2.667,2,3,3"
    )
...
def test_monotone_x_3():
    ...
    assert (
        line([[0, 200], [100, 100], [100, 0], [200, 0]])
        == "M0,200C33.333,183.333,66.667,166.667,100,100C100,100,100,0,100,0C133.333,0,166.667,0,200,0"
    )
    assert (
        line([[0, 200], [100, 100], [200, 100], [200, 0]])
        == "M0,200C33.333,150,66.667,100,100,100C133.333,100,166.667,100,200,100C200,100,200,0,200,0"
    )
...
def test_monotone_x_4():
    ...
    assert (
        line([[200, 0], [100, 50], [100, 150], [0, 200]])
        == "M200,0C166.667,8.333,133.333,16.667,100,50C100,50,100,150,100,150C66.667,183.333,33.333,191.667,0,200"
    )
...
def test_monotone_x_6():
    ...
    assert (
        ...
        == "M0,1C0.333,2,0.667,3,1,3C1.333,3,1.667,1,2,1C2.333,1,2.667,2,3,3L3,0C2.667,0,2.333,0,2,0C1.667,0,1.333,0,1,0C0.667,0,0.333,0,0,0Z"
    )
