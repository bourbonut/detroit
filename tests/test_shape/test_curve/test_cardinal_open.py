...
def test_cardinal_open_3():
    assert (
        d3.line().set_curve(d3.curve_cardinal_open(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]])
...
def test_cardinal_open_6():
    ...
    assert d3.area().set_curve(d3.curve_cardinal_open)([[0, 1], [1, 3], [2, 1], [3, 3]]), (
        area([[0, 1], [1, 3], [2, 1], [3, 3]])
    )
...
def test_cardinal_open_7():
    assert (
        d3.area().set_curve(d3.curve_cardinal_open(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]])
