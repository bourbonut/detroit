...
def test_cardinal_2():
    ...
    assert d3.line().curve(d3.curve_cardinal)([[0, 1], [1, 3], [2, 1], [3, 3]]) == line(
        [[0, 1], [1, 3], [2, 1], [3, 3]]
    )
...
def test_cardinal_3():
    assert (
        d3.line().curve(d3.curve_cardinal(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]])
...
def test_cardinal_4():
    ...
    assert d3.line().curve(d3.curve_cardinal(0.5))(
        [[0, 1], [1, 3], [2, 1], [3, 3]]
    ) == line([[0, 1], [1, 3], [2, 1], [3, 3]])
...
def test_cardinal_6():
    ...
    assert d3.area().curve(d3.curve_cardinal)([[0, 1], [1, 3], [2, 1], [3, 3]]) == area(
        [[0, 1], [1, 3], [2, 1], [3, 3]]
    )
...
def test_cardinal_7():
    assert (
        d3.area().curve(d3.curve_cardinal(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]])
...
def test_cardinal_8():
    ...
    assert d3.area().curve(d3.curve_cardinal(0.5))(
        [[0, 1], [1, 3], [2, 1], [3, 3]]
    ) == a([[0, 1], [1, 3], [2, 1], [3, 3]])
