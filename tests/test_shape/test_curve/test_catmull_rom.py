...
def test_catmull_rom_3():
  ...
  assert d3.line().curve(d3.curve_catmull_rom)([[0, 1], [1, 3], [2, 1], [3, 3]]) == line([[0, 1], [1, 3], [2, 1], [3, 3]])

def test_catmull_rom_4():
  line = d3.line().curve(d3.curve_catmull_rom(0.5))
  assert d3.line().curve(d3.curve_catmull_rom(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]]) == line([[0, 1], [1, 3], [2, 1], [3, 3]])
...
def test_catmull_rom_6():
  ...
  assert d3.area().curve(d3.curve_catmull_rom)([[0, 1], [1, 3], [2, 1], [3, 3]]) == area([[0, 1], [1, 3], [2, 1], [3, 3]])

def test_catmull_rom_7():
  area = d3.area().curve(d3.curve_catmull_rom(0.5))
  assert d3.area().curve(d3.curve_catmull_rom(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]]) == area([[0, 1], [1, 3], [2, 1], [3, 3]])
