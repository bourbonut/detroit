...
def test_cardinal_closed_1():
    line = d3.line().set_curve(d3.curve_cardinal_closed)
    assert line([]) is None
...
def test_cardinal_closed_2():
    line = d3.line().set_curve(d3.curve_cardinal_closed(0))
    assert d3.line().set_curve(d3.curve_cardinal_closed)(
        [[0, 1], [1, 3], [2, 1], [3, 3]]
    ) == line([[0, 1], [1, 3], [2, 1], [3, 3]])
...
def test_cardinal_closed_3():
    assert (
        d3.line().set_curve(d3.curve_cardinal_closed(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]])
        == "M1,3C1.167,3,1.833,1,2,1C2.167,1,3.167,3,3,3C2.833,3,0.167,1,0,1C-0.167,1,0.833,3,1,3"
    )


def test_cardinal_closed_4():
    line = d3.line().set_curve(d3.curve_cardinal_closed(0.5))
    assert d3.line().set_curve(d3.curve_cardinal_closed(0.5))(
        [[0, 1], [1, 3], [2, 1], [3, 3]]
    ) == line([[0, 1], [1, 3], [2, 1], [3, 3]])


def test_cardinal_closed_5():
    area = d3.area().set_curve(d3.curve_cardinal_closed)
    assert area([]) is None
...
def test_cardinal_closed_6():
    area = d3.area().set_curve(d3.curve_cardinal_closed(0))
    assert d3.area().set_curve(d3.curve_cardinal_closed)(
        [[0, 1], [1, 3], [2, 1], [3, 3]]
    ) == area([[0, 1], [1, 3], [2, 1], [3, 3]])
...
def test_cardinal_closed_7():
    assert (
        d3.area().set_curve(d3.curve_cardinal_closed(0.5))([[0, 1], [1, 3], [2, 1], [3, 3]])
...
def test_cardinal_closed_8():
    area = d3.area().set_curve(d3.curve_cardinal_closed(0.5))
    assert d3.area().set_curve(d3.curve_cardinal_closed(0.5))(
        [[0, 1], [1, 3], [2, 1], [3, 3]]
    ) == area([[0, 1], [1, 3], [2, 1], [3, 3]])
