...
def test_area_15():
    ...
    assert (
        a([[0, 1], [1, 3], [2, 1]])
        == "M0,1C0,1,0.700,3,1,3C1.300,3,2,1,2,1L2,0C2,0,1.300,0,1,0C0.700,0,0,0,0,0Z"
    )
    assert (
        a([[0, 1], [1, 3], [2, 1], [3, 3]])
        == "M0,1C0,1,0.700,3,1,3C1.300,3,1.700,1,2,1C2.300,1,3,3,3,3L3,0C3,0,2.300,0,2,0C1.700,0,1.300,0,1,0C0.700,0,0,0,0,0Z"
    )
